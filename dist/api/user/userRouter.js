...
var commonValidations = {
  id: import_zod2.z.string().refine((data) => !Number.isNaN(Number(data)), "ID must be a numeric value").transform(Number).refine((num2) => num2 > 0, "ID must be a positive number")
...
var GetUserSchema = import_zod3.z.object({
  params: import_zod3.z.object({ id: commonValidations.id })
});
...
// src/api-docs/openAPIRouter.ts
var openAPIRouter = import_express2.default.Router();
...
var userRouter = import_express4.default.Router();
